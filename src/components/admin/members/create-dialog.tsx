...
export function CreateMemberDialog({
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      mutate("/api/users"); // Revalidate or refresh the user list in SWR
      // Handle success (e.g., show a toast or reset form)
    } catch (error) {
      console.error("API Error:", error);
      setIsSubmitting(false); // Handle error (e.g., show error toast)
    }
